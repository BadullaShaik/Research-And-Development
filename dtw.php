  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav" class="nav nav-tabs">
     ...
     <ul class="nav navbar-nav navbar-right">
		<li><a href="registration.php">StudentRegistration</a></li>
		<li><a href="dtwlogin.php">Admin Login</a></li>
		<!--<li><a href="retrive.php">Registered Students</a></li>-->
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				<!-- Indicators -->
					...
					<div class="carousel-inner">
							...
							<div class="item active">
									<img src="img/sic1.jpg" alt="" style="width:100%;">
							...
							<div class="item">
									<img src="img/sic.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/sic3.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/sic2.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/sic4.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/sic5.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
				...
				<div class="panel panel-info">
					<div class="panel-body">
						...
						<marquee><a href="sic.pdf" target="_blank"><span style="color:#3399ff">DESIGN THINKING WORKSHOP</span></a></marquee>
					</div>
				</div>
				<table class="table">
					<tr>
