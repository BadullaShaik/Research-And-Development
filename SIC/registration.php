		...
		<form class="form-horizontal" method="post" action="registration.php">
						...
						<div class="form-group">
							...
							<div class="col-sm-offset-4 col-sm-10">						
								<div class="radio">
									  <label><input type="radio" name="workshopOn" value="Tuesday,11th October 2017"required>Tuesday,11th October 2017</label>
								</div>
								<div class="radio">
									  <label><input type="radio" name="workshopOn" value="Saturday,15th October 2017"required>Saturday,15th October 2017</label>
								</div>
								<div class="radio">
