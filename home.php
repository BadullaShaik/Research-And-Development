...
">
   ...
   <h5 style="position: absolute;
    padding-left:69%;
    top: 1%;"><a href="http://jntuacep.ac.in/deptinfo.php?id=4-94">Jntuacep</a></h5>
...
<div>
	<div class='container-fluid'>
		<div class='row'>
			...
			<div class='col-md-8 text-center' style="background:#CCCCCC">
				<div class='row'>
					<h2 style="color:#9933CC">Department of Computer Science and Engineering</h2>
				</div>
				<div>
					<h2 style="color:#9933CC">Research and Development</h2>
				</div>							
			</div>
			
			<div class='col-md-2 text-center'>
				<h5><a href="http://jntuacep.ac.in/deptinfo.php?id=4-94">Jntuacep</a>&nbsp;&nbsp;<a href="http://jntuacep.ac.in/deptinfo.php?id=4-94">Home</a></h5>
			</div>
		</div>
	</div>
</div>
<nav class="navbar navbar-default">
	 <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="color:#FFF;border-radius:5px;background:#673ab7;">R&D</a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a data-toggle="modal" href='#' data-target="#register"><span class="glyphicon glyphicon-user">StudentRegistration</span></a></li>
			<li><a data-toggle="modal" href='#' data-target="#login"><span class="glyphicon glyphicon-user">Login</span></a></li>
		</ul>
	</div>	 
</nav>
    ...
    <div id="Home" class="tab-pane fade in active">	
		<div class="container-fluid">
			<div id="myCarousel" class="carousel slide" data-ride="carousel">
				<!-- Indicators -->
					...
					<div class="carousel-inner">
							...
							<div class="item active">
									<img src="img/group final.jpg" style="width:100%;height:500px;" alt="Final Batch">
							...
							<div class="item">
									<img src="img/2011-2015.jpg" style="width:100%;height:500px;" alt="2011-2015">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/2012-2016.jpg" style="width:100%;height:500px;" alt="2012-2016">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
				...
				<h3>Mission</h3>
				<p>
					To do exemplary Research work which enable us to contribute to the societal needs. Provide state of art computer facilities in the department.
...
Producing students who are knowledgeable, society-focussed, creative, adaptive and motivated.</p>
	...
	<div id="About" class="container tab-pane fade" style="background:white;">
			<h3>About :</h3>
			<p> 
					...
					<div class="modal-body">
						...
						<div class="form-group">        
							<div class="col-sm-offset-2 col-sm-10">
								<input type="submit" name="register" value="Register" onclick="return Validate()" class="btn btn-primary pull-right">
							</div>
						</div>
					</form>
				</div>
