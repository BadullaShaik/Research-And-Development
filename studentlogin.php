...
function showSlides(n) {
  ...
  dots[slideIndex-1].className += " active";
    ...
    <table align="center">
    	<tr>
        	<td>
                ...
                <a href="access1.php"><h4>I B.Tech Student Login</h4></a>
                 
                 <a href="access2.php"><h4>II.B.tech Student Login</h4></a>
                 
                 <a href="access3.php"><h4>III.B.tech Student Login</h4></a>
                 
                 <a href="access4.php"><h4>IV.B.tech Student Login</h4></a>
    ...
    <table align="center" style="background-color:#FF0000; color:#CCCCCC; font-size:16px;">
    	<tr>
        	<td>
