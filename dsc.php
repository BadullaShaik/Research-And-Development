  ...
  <div class="container-fluid">
    <ul class="nav navbar-nav" class="nav nav-tabs">
     ...
     <ul class="nav navbar-nav navbar-right">
		<li><a data-toggle="modal" data-target="#dscregister"><span class="glyphicon glyphicon-user">StudentRegistration</span></a></li>
		<li><a data-toggle="modal" data-target="#dsclogin"><span class="glyphicon glyphicon-user">Login</span></a></li>
				...
				<!-- Indicators -->
					...
					<div class="carousel-inner">
							...
							<div class="item active">
									<img src="img/photo3.jpg" alt="" style="width:100%;">
							...
							<div class="item">
									<img src="img/photo6.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/photo4.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img/photo1.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img//photo2.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
							...
							<div class="item">
									<img src="img//photo5.jpg" alt="" style="width:100%;">
									<div class="carousel-caption">
										<h3></h3>
									</div>
							</div>
...
<li>Sustainability is not only widespread, it also serves as a guiding principle in all activities of the [sic!].</li>
	...
	<div class="modal fade" id="dscregister" role="dialog">
		<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" action="dscregister.php" enctype="multipart/form-data">
	...
	<div class="modal fade" id="dsclogin" role="dialog">
		<div class="modal-dialog" style="width:35%;height:45%;">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" action="dsclogin.php">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
			...
			$query=mysql_query("select * from dscregister where year='I Year' ");
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
			$query=mysql_query("select * from dscregister where year='II Year' ");
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
			$query=mysql_query("select * from dscregister where year='III Year' ");
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php
			$query=mysql_query("select * from dscregister where year='IV Year' ");
