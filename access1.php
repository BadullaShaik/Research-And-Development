...
<div class="container">
    ...
    <a href="userAccount1.php?logoutSubmit=1" class="logout">Logout</a>
    <div class="regisFrm">
        ...
        <li align="left"><a href="cse2.php"><h1>C Programming</h1></a></li>
        <li align="left"><a href="cse2.php"><h1>Java</h1></a></li>
    ...
    <div class="regisFrm" align="center">
        <form action="userAccount1.php" method="post">
        <tr>
